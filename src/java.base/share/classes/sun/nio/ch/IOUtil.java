...
public final class IOUtil {
    ...
    static int write(FileDescriptor fd, ByteBuffer src, long position,
                     boolean directIO, boolean async, int alignment, NativeDispatcher nd)
        throws IOException
    {
    ...
    static long write(FileDescriptor fd, ByteBuffer[] bufs, boolean async, NativeDispatcher nd)
        throws IOException
    {
    ...
    static long write(FileDescriptor fd, ByteBuffer[] bufs, int offset, int length,
        ...
        throws IOException
    {
        return write(fd, bufs, offset, length, directIO, false, alignment, nd);
    }
